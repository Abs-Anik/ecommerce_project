                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_size_en" class="form-control" value="Small, Large, Medium" data-role="tagsinput" required=""> 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_size_hin" class="form-control" value="Small, Large, Medium" data-role="tagsinput" required=""> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="short_desp_hin" id="textarea" class="form-control" required placeholder="Textarea text" required=""></textarea>
                                        </div>
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="long_desp_en" id="editor1" class="form-control" rows="10" cols="80" required="">Long Description English</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="long_desp_hin" id="editor2" class="form-control" rows="10" cols="80" required="">Long Description Hindi</textarea>
                                        </div>
                                    </div>
                            </div>
                        </div>
